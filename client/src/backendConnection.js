...
async function search_post_function(dataObject) {
...
""" */
async function query_all_posts_function(dataObject) {
...
"""
*/
async function registerFunction(dataObject) {
...
"""
*/
async function loginFunction(dataObject) {
...
"" */
async function verifyFunction(dataObject) {
  const url =
...
module.export = {
  query_all_posts_function,
  search_post_function,
